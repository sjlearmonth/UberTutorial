...
//  UberTutorial
//
//  Created by Stephen Learmonth on 07/07/2020.
...
class PickupController: UIViewController {
    ...
    func configureUI() {
        ...
        cancelButton.anchor(top: view.safeAreaLayoutGuide.topAnchor, left: view.safeAreaLayoutGuide.leftAnchor, paddingLeft: 16)
